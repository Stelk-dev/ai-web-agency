...
export default function UseCasePage() {
  ...
  const seoKey = {
    "suprem-milk": "project_supremmilk",
    "n-and-group": "project_nandgroup",
    "virality-system": "project_viralitysystem",
    "extra-outdoor": "project_extraoutdoor",
  }[slug];

  const seo = t(`seo.${seoKey}`, { returnObjects: true });
  ...
  return (
    <>
      <SEO keywords={seo.keywords} robots="index, follow" />
          ...
          >
            ...
            >
              ...
              >
                ...
                <h3
                  style={{ color: "white", fontWeight: "500", margin: "0px" }}
                >
